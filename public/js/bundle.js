    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 7:
          ...
          (0, _alerts.showAlert)("error", "Failed to login the user!");
        case 10:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: "GET",
            url: "http://localhost:8001/api/v1/users/auth/logout"
          });
        case 3:
          res = _context2.sent;
          if (res.data.status === "success") {
        ...
        case 7:
          ...
          (0, _alerts.showAlert)("error", "Failed to log out the user!");
        case 10:
        case "end":
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } /* eslint-disable */
var stripePromise = (0, _stripeJs.loadStripe)("pk_test_51Q5SwYDCNxL2XOwanZ3tQyiVU1UgyOQ5uSaLXeEDDnEnoIk5YOl8l3Pp3pvCDHHmrSHEkiGydCbSTU4ZvTsfEDCS00jFAUjEKo");
  ...
  if (userForm) {
    userForm.addEventListener('submit', /*#__PURE__*/function () {
      var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
        var formData, name, email, photo, res;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault();
              ...
              (0, _alerts.showAlert)('error', 'Invalid input data! Please fill in the fields!');
            ...
            case 11:
              res = _context.sent;
              if (res.data.status === 'success') {
                (0, _alerts.showAlert)('success', 'The data was successfully updated!');
                window.setTimeout(function () {
                  (0, _alerts.hideAlert)();
                }, 2000);
              } else {
                (0, _alerts.showAlert)('error', 'Failed to update the data! Please, try again later!');
                window.setTimeout(function () {
                  (0, _alerts.hideAlert)();
                }, 2000);
              }
